  ...
  return (
    ...
    >
      ...
      <Link 
        ...
        className="relative px-2 sm:px-6 py-2 sm:py-4 bg-background/50 flex flex-col items-center justify-between border-b border-border/70 overflow-hidden min-h-[170px] xs:min-h-[210px] sm:min-h-[280px] md:min-h-[360px] cursor-pointer"
        ...
        <div className="relative w-full flex items-center justify-center py-1 sm:py-2 max-w-[480px] flex-1">
          {project.type === 'Mobile App' ? (
            <div className="relative w-full flex items-center justify-center transition-transform duration-300 group-hover:scale-[1.02]">
              ...
              <div 
                aria-hidden="true" 
                className="pointer-events-none absolute w-28 sm:w-48 h-28 sm:h-48 bg-accent/15 rounded-full blur-3xl -z-10 opacity-75 group-hover:opacity-100 transition-opacity"
              />
