...
export function BrowserMockup({
  ...
  return (
    <div className={cn("relative w-full rounded-2xl overflow-hidden bg-surface border border-border shadow-[0_20px_50px_rgba(0,0,0,0.6)] select-none", className)}>
      {/* Top Window Bar */}
      <div className="h-10 px-4 bg-[#0F1420] border-b border-border/80 flex items-center justify-between gap-4">
        {/* Traffic Light Dots */}
        ...
        {/* Address URL Pill */}
        <div className="flex-1 max-w-sm mx-auto h-6 rounded-md bg-background/70 border border-border/60 flex items-center justify-center px-3 text-[11px] font-mono text-muted-foreground truncate gap-1.5">
